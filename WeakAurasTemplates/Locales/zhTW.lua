...
-- WeakAuras/Templates
	...
	L["Always shows the aura, turns grey when on cooldown, blue when unusable."] = "永遠顯示提醒效果，冷卻中變成灰色，不可使用時變成藍色。"
	L["Always shows the aura, turns grey when on zero charges, blue when not usable."] = "永遠顯示提醒效果，次數為 0 時變成灰色，不可使用時變成藍色。"
	L["Always shows the aura, turns grey when on zero charges, highlight when active, blue on insufficient resources."] = "永遠顯示提醒效果，次數為 0 時變成灰色，作用時顯著標示，資源不足時變成藍色。"
	...
	L["On Procc Trinkets (Buff)"] = "機率觸發型飾品 (增益)"
	...
	L["Stagger"] = "醉仙緩勁"
	L["Totems"] = "圖騰"
	L["Track the charge and proc, highlight while proc is active, turns red when out of range, blue on insufficient resources."] = "監控次數和機率觸發，機率觸發時顯著標示，超出範圍時變成紅色，資源不足時變成藍色。"
