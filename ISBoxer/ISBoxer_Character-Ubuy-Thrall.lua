isboxer.Character.Name = "Ubuy-Thrall";
isboxer.Character.ActualName = "Ubuy";
isboxer.Character.QualifiedName = "Ubuy-Thrall";
...
isboxer.Output("Character 'Ubuy-Thrall' activated");
