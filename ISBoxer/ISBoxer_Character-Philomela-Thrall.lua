isboxer.Character.Name = "Philomela-Thrall";
isboxer.Character.ActualName = "Philomela";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="one of each") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite Ashimagari\n/invite Ubuy\n/invite Anastasoula\n/invite Lorakain\n",nil,nil,nil,1);
	...
	if (isboxer.CharacterSet.Name=="Philomela Ana Dio Lyssia Ubuy") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite Anastasoula\n/invite Diomedës\n/invite Lyssiá\n/invite Ubuy\n",nil,nil,nil,1);
	...
	if (isboxer.CharacterSet.Name=="Shoulder Farm") then
		isboxer.SetMacro("FTLAssist","BACKSPACE","/assist [nomod:alt,mod:lshift,nomod:ctrl]Philomela;[nomod:alt,mod:rshift,nomod:ctrl]Anastasoula;[nomod:alt,nomod:shift,mod:lctrl]Diomedes;[mod:lalt,nomod:shift,nomod:ctrl]Luscinia;[nomod:alt,mod:lshift,mod:lctrl]Ubuy;[mod:lalt,mod:lshift,nomod:ctrl]Ashimagari;[nomod:alt,mod:rshift,mod:lctrl]Darsaadi;[mod:lalt,mod:rshift,nomod:ctrl]Lorakain\n",1,1,1,1);
...
isboxer.Output("Character 'Philomela-Thrall' activated");
