isboxer.Character.Name = "Lorakain-Thrall";
isboxer.Character.ActualName = "Lorakain";
isboxer.Character.QualifiedName = "Lorakain-Thrall";
...
isboxer.Output("Character 'Lorakain-Thrall' activated");
