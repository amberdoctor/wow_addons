isboxer.Character.Name = "Ashimagari-Thrall";
isboxer.Character.ActualName = "Ashimagari";
isboxer.Character.QualifiedName = "Ashimagari-Thrall";
...
isboxer.Output("Character 'Ashimagari-Thrall' activated");
