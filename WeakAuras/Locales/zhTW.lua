...
L["A WeakAura just tried to use a forbidden function but has been blocked from doing so. Please check your auras!"] = "一個 WeakAura 提醒效果嘗試使用被禁止的功能，而且已經被阻擋了。請檢查你的提醒效果!"
L["Absorb"] = "吸收量"
