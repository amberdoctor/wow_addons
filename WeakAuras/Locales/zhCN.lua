...
L["A WeakAura just tried to use a forbidden function but has been blocked from doing so. Please check your auras!"] = "WeakAura 由于尝试使用一项被禁止的功能而被阻止，请检查你的光环！"
L["Absorb"] = "吸收"
...
L["Event(s)"] = "事件"
L["Every Frame"] = "所有框架"
L["EXPERIMENTAL Profiling Data:"] = "实验性 分析数据："
...
L["No Children"] = "无子物件"
L["No Instance"] = "没有队伍"
L["No Profiling information saved."] = "没有分析信息被保存"
L["none"] = "无"
L["None"] = "无"
...
L["Profiling already started."] = "分析已开始"
L["Profiling not running."] = "分析未开始"
L["Profiling started."] = "分析开始"
L["Profiling still running, stop before trying to print."] = "分析一开始，打印前需要先停止分析"
L["Profiling stopped."] = "分析结束"
L["Progress"] = "进度"
...
L["Square"] = "方块"
L["Stacks"] = "层数"
L["Stacks Text Color"] = "堆叠文字颜色"
L["Stacks Text Size"] = "堆叠文字尺寸"
